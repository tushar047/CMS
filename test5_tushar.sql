...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=244102096ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test5_tushar&table=admins">`test5_tushar`.`admins`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=test5_tushar&table=content">`test5_tushar`.`content`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=newsbuzz&table=users">`newsbuzz`.`users`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=furniture-shop&table=admin">`furniture-shop`.`admin`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="66746262475f474c706039377b22585f">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="furniture-shop" targettable="">
            ...
            Queried time
                            ...
                            targetdb="furniture-shop" targettable="admin">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `admin`</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="test5_tushar" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE content(
    id int AUTO_INCREMENT PRIMARY KEY,
    title VARCHAR(225) NOT NULL,
    content TEXT
    )DEFAULT CHARSET=latin1;</span>
                        </div>
                                            <div class="message history collapsed hide"
                            targetdb="newsbuzz" targettable="">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="newsbuzz" targettable="users">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT `password` FROM `users` WHERE `users`.`id` = 17</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="newsbuzz" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">INSERT INTO users VALUES(1,&#039;admin&#039;,&#039;tushar&#039;,&#039;talreja&#039;,&#039;admin@gmail.com&#039;,&#039;123456&#039;,&#039;admin&#039;);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="newsbuzz" targettable="users">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `users`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="test5_tushar" targettable="content">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `content`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test5_tushar" targettable="admins">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">CREATE TABLE articles(id int AUTO_INCREMENT PRIMARY KEY,
                      publicationDate date NOT null,
                      title text NOT null,
                      summary text NOT null,
                      content text NOT null);</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="test5_tushar" targettable="admins">
                            <div class="action_content">
